                ...
                <tr>
                  <td>
                    <table width="220" border="0" cellpadding="0" cellspacing="0" align="left" class="col">
                      <tbody>
                        <tr>
                          <td align="left"> <img src="http://127.0.0.1:8005/frontend/img/logo.png" width="32" height="32" alt="logo" border="0" /></td>
                        </tr>
                        <tr class="hiddenMobile">
                          <td height="40"></td>
                        </tr>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td style="font-size: 12px; color: #5b5b5b; font-family: 'Open Sans', sans-serif; line-height: 18px; vertical-align: top; text-align: right;">
                            <small>ORDER:</small>{{$order_details[0]->order_id}}<br />
          ...
          <tbody>
            ...
            @foreach($order_details as $orderdet)
                <tr id="{{$orderdet->id}}">
                    ...
                    <td>										
                    <p class="cp_price">{{$orderdet->quntity}}</p>
                    </td>
                    <td><p class="cp_price">{{$orderdet->price}}</p></td>
                    <td align="center"><p class="cpp_total" align="center">{{$orderdet->gross_amount}}</p></td>
                        ...
                        <table width="220" border="0" cellpadding="0" cellspacing="0" align="left" class="col">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              {{$order_details[0]->address}}<br>{{$order_details[0]->city}},{{$order_details[0]->state}},<br>{{$order_details[0]->country}}<br>
                              </td>
                            </tr>
                          </tbody>
                        </table>
