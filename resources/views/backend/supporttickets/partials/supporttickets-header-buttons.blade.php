<!--Action Button-->
@if( Active::checkUriPattern( 'admin/supporttickets' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.supporttickets.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.supporttickets.all' ) }}
            </a>
        </li>
        @permission( 'create-supportticket' )
            <li>
                <a href="{{ route( 'admin.supporttickets.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.supporttickets.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
