...
Route::get('frontend/login','LoginController@index');
Route::get('frontend/logout','LoginController@logout');
Route::post('frontend/login/store','LoginController@store')->name('login.store');
/*
